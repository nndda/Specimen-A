...
func _ready() -> void: MonitorVariables()
...
func _physics_process( delta ) -> void:
    ...
    if !attacking:
        ...
        if $AreaShake.monitorable: ShakeFinished()
...
func ShakeStarted() -> void: glbl.is_shake_by_player = true
#	$AreaShake.set_deferred("monitorable",true)
#	print("ShakeStarted")
#	$AreaShake.monitorable = true
func ShakeFinished() -> void: glbl.is_shake_by_player = false
#	$AreaShake.set_deferred("monitorable",false)
#	print("ShakeFinished")
#	$AreaShake.monitorable = false
...
func DamagePlayer( power : float ) -> void: if !invincible:
